...
dates = ['2010-01-01 05:05:21.992','2011-06-12 05:05:32.122']
dates2 = [['2010-01-01 05:05:21.992','Name1','path1/asdf/juir8.test'],['2011-06-12 05:05:32.122','Name2','path2/3/sadfsad.test']]
    ...
    def csvtogource(self):
        ...
        for list in dates2:
            for x, item in enumerate(list):
                try:
                    list[x] = time.mktime(datetime.datetime.strptime(item, '%Y-%m-%d %H:%M:%S.%f').timetuple())
